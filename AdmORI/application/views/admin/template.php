...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?php base_url() ?>images/img-02.png" />
...
<div class="col-md-2">
  <a>
    <img src="<?php base_url() ?>images/img-02.png" >
  </a>
</div>
<div class="col-md-6">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href=<?php echo base_url('admin/keloladosen') ?>>
              <i class="menu-icon mdi mdi-account-location"></i>
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © 2019
              <a>Kerja Praktik</a> Institut Teknologi Sumatera</span>
          </div>
        </footer>
