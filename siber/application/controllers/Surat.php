...
class Surat extends CI_Controller {
    ...
    public function surat_keluar_laporan() {
        ...
        if ($mau_ke == "del") {
            ...
            if ($this->upload->do_upload('file_surat')) {
                $up_data = $this->upload->data('file_name');
                $this->surat_model->update_surat_keluar_laporan_with_file($kode, $no_agenda, $indek_berkas, $uraian, $dari, $no_surat, $tgl_surat, $ket, $up_data, $id_post);
            } else {
                $this->surat_model->update_surat_keluar($kode, $no_agenda, $indek_berkas, $uraian, $dari, $no_surat, $tgl_surat, $ket, $id_post);
            }
            $this->session->set_flashdata('message', message_box('Data telah diperbaharui. ' . $this->upload->display_errors()));
    ...
    public function surat_klarifikasi_keluar2() {
        ...
        if ($mau_ke == "del") {
            ...
            if ($this->upload->do_upload('file_surat')) {
                $up_data = $this->upload->data('file_name');
                $this->surat_model->update_surat_klarifikasi_keluar2_with_file($kode, $no_agenda, $indek_berkas, $uraian, $dari, $no_surat, $tgl_surat, $ket, $up_data, $id_post);
            } else {
                $this->surat_model->update_surat_klarifikasi_keluar2($kode, $no_agenda, $indek_berkas, $uraian, $dari, $no_surat, $tgl_surat, $ket, $id_post);
            }
            $this->session->set_flashdata('message', message_box('Data telah diperbaharui. ' . $this->upload->display_errors()));
            redirect('surat/surat_klarifikasi_keluar2');
        } else {
    ...
    public function surat_klarifikasi_masuk() {
        ...
        if ($mau_ke == "del") {
            ...
            if ($this->upload->do_upload('file_surat')) {
                $up_data = $this->upload->data('file_name');
                $this->surat_model->update_ssurat_klarifikasi_masuk_with_file($kode, $no_agenda, $indek_berkas, $uraian, $dari, $no_surat, $tgl_surat, $ket, $up_data, $id_post);
            } else {
