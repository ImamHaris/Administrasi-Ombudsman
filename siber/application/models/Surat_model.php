...
class Surat_model extends CI_Model {
    ...
    public function insert_surat_keluar_laporan_with_file($no_surat, $tgl_surat, $tujuan, $perihal, $up_data) {
        $data = array(
            'no_surat' => $no_surat,
            'tgl_surat' => $tgl_surat,
            'tujuan' => $tujuan,
    ...
    public function insert_surat_keluar_laporan($no_surat, $tgl_surat, $tujuan, $perihal, $up_data) {
        $data = array(
            'no_surat' => $no_surat,
            'tgl_surat' => $tgl_surat,
            'tujuan' => $tujuan,
    ...
    public function update_surat_keluar_laporan_with_file($no_agenda, $kode, $uraian, $dari, $no_surat, $tgl_surat, $ket, $up_data, $id_post) {
        $data = array(
            'no_agenda' => $no_agenda,
            'kode' => $kode,
            'isi_ringkas' => $uraian,
    ...
    public function update_surat_keluar_laporan($no_agenda, $kode, $uraian, $dari, $no_surat, $tgl_surat, $ket, $id_post) {
        $data = array(
            'no_agenda' => $no_agenda,
            'kode' => $kode,
            'isi_ringkas' => $uraian,
