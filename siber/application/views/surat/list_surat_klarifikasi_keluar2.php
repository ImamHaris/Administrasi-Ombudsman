...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Surat Klarifikasi Keluar II</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('sibers'); ?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active">Surat Klarifikasi Keluar II</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-xs-6">
                                <a class="btn btn-primary btn-sm btn-flat" href="<?php echo site_url('surat/surat_klarifikasi_keluar2/add'); ?>"><i class="fa fa-plus"></i>
                                    <span class="hidden-xs"> Tambah Data</span></a></li>
                            </div>
                            <div class="box-tools col-xs-6">
                                <form method="post" action="<?php echo site_url('surat/surat_klarifikasi_keluar2/cari'); ?>">
                            ...
                            if (empty($data)) {
                                ...
                                foreach ($data as $b) {
                                    ...
                                    <tr>
                                        ...
                                        <td ><?php echo limit_word($b->tujuan, 50, 0) . "<br><b>File : </b><i><a href='" . base_URL() . "assets/upload/surat_klarifikasi_keluar2/" . $b->file . "' target='_blank'>" . limit_word($b->file, 50, 1) . "</a>"; ?></td>
                                        <td><?php echo $b->perihal; ?></td>
                                        <td><?php echo $b->Asisten; ?></td>
                                        <td>
                                            <?php
                                            if ($b->pengolah == $this->session->user_id) {
                                                ?>
                                                <div>
                                                    <a href="<?php echo site_url('surat/surat_klarifikasi_keluar2/edit'); ?>/<?php echo $b->id_surat ?>"
                                                       data-toggle="tooltip" class="btn btn-success btn-sm" title="Edit Data"><i class="fa fa-pencil">Sunting</i></a>
                                                    <a href="<?php echo site_url('surat/surat_klarifikasi_keluar2/del'); ?>/<?php echo $b->id_surat ?>"
                                                ...
                                                ?>
                                                <div>
                                                <a href="<?php echo site_url('assets/upload/surat_klarifikasi_keluar2'); ?>/<?php echo $b->file ?>"
