            ...
            <div class="col-xs-12">
                <div class="box box-success">
                    <div class="box-header">
                        <div class="row">
                            <div class="col-xs-6">
                                <a class="btn btn-primary btn-sm btn-flat" href="<?php echo site_url('surat/surat_klarifikasi_masuk/add'); ?>"><i class="fa fa-plus"></i>
                                    <span class="hidden-xs"> Tambah Data</span></a></li>
                            </div>
                            <div class="box-tools col-xs-6">
                                <form method="post" action="<?php echo site_url('surat/surat_klarifikasi_masuk/cari'); ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($b->pengolah == $this->session->user_id) {
                                                ...
                                                ?>
                                                <div>
                                                <a href="<?php echo site_url('assets/upload/surat_klarifikasi_masuk'); ?>/<?php echo $b->file ?>"
